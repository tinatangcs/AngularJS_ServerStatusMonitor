(function() {
    ...
    /* @ngInject */
    function triMenuItemController($scope, $mdSidenav, $state, $filter, $log, triBreadcrumbsService,serverService,triMenu) {
        ...
        switch(triMenuItem.item.type) {
            ...
            case 'button':
                ...
                triMenuItem.clickButton = clickButton;
        ...
        function clickButton(item) {
            ...
            serverService.switchServer(item.params.server)
            // console.log(triMenuItem,triMenu);
            // $log.info('hahah something',item);
